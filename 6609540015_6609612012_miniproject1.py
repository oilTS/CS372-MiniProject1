...
>(link doc
https://tuipied-my.sharepoint.com/:w:/g/personal/thanaporn_thongs_dome_tu_ac_th/IQCjEZ6xwhyWRYxt-2ghvpW1AT_7M2sN8mWBW6V6nICLkFg?e=V9Pehz)
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
ข้อมูลจะไหลผ่านชั้นซ่อน (Hidden Layer) โดยที่ในที่นี้จะใช้ 1 ชั้นที่มี 50 โหนด โมเดลจะทำการคำนวณค่าน้ำหนัก (Weights) และใช้ฟังก์ชันกระตุ้น (Activation Function) แบบ tanh เพื่อหาความสัมพันธ์ที่ซับซ้อนระหว่างคุณลักษณะต่าง ๆ จนสามารถระบุประเภทเห็ดได้
"""
